...
New-AzureRmResourceGroupDeployment -Name vnet-deployment-wp-prod-westus2 -ResourceGroupName rg-wp-prod-westus2-001 -TemplateFile $HOME/azuredeploy.json -TemplateParameterFile $HOME/azuredeploy.parameters.json -Mode Incremental -RollbackToLastDeployment
...
New-AzureRmResourceGroupDeployment -Name vmss-deployment-jumpbox-wp-prod-westus2 -ResourceGroupName rg-wp-prod-westus2-001 -TemplateFile $HOME/azuredeploy.json -TemplateParameterFile $HOME/azuredeploy.parameters.json -Mode Incremental -RollbackToLastDeployment
